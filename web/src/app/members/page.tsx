            ...
            {filtered.map((member) => {
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-xl border border-amber-900/20 bg-[#22223a] text-left transition-all ${
                    isExpanded ? "pb-4" : ""
                  }`}
                >
                  <div className="flex items-center gap-3 p-3.5">
                    {member.pictureUrl ? (
                      ...
                      <img
                        ...
                        alt=""
                        className="h-11 w-11 shrink-0 rounded-full object-cover ring-2 ring-amber-900/30"
                      />
                    ) : (
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#2a2a4a] text-sm font-bold text-amber-200/60 ring-2 ring-amber-900/30">
                    ...
                    <span
                      className="shrink-0 text-amber-200/30 transition-transform"
                  ...
                  {isExpanded && (
                    <div className="mx-3.5 border-t border-amber-900/20 pt-3">
